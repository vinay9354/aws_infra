...
#   value = {
#     for k, v in module.dev_eks.managed_node_groups : k => {
#       id            = v.id
#       arn           = v.arn
#       status        = v.status
...
#   value = {
#     for k, v in module.dev_eks.cluster_addons : k => {
...
#     certificate_authority = module.dev_eks.cluster_certificate_authority_data
